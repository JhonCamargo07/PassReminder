...
import static ModelDAO.Conexion.close;
import static ModelDAO.Conexion.getConnection;
...
@Override
    public List<PasswordVO> seleccionar() {
        ...
        try {
            ...
            stmt.setInt(1, UserVO.getIdSesion());
            ...
            while (rs.next()){
                ...
                password = new PasswordVO(idPassword, pagina, usuario, pass);
    ...
    @Override
    public List<PasswordVO> seleccionarPassword(String parametro) {
        Connection conn = null;
        PreparedStatement stmt = null;
        ResultSet rs = null;
        PasswordVO password = null;
...
//            stmt.setString(3, parametro);
    ...
    @Override
    public int insertar(PasswordVO password) throws SQLException {
        Connection conn = null;
        PreparedStatement stmt = null;
        int registros = 0;
    ...
    @Override
    public int actualizar(PasswordVO password) throws SQLException {
        Connection conn = null;
        PreparedStatement stmt = null;
        int registros = 0;
    ...
    @Override
    public int eliminar(PasswordVO password) throws SQLException {
        Connection conn = null;
        PreparedStatement stmt = null;
        int registros = 0;
